## This file came from https://github.com/Digilent/digilent-xdc/blob/master/Zybo-Z7-Master.xdc
## NOTE: Comments on each line designate the actual pin on the processor and the pin on the schematics
##
...
## ---- Pmod JC Pins in Use ----
## pin 1 -- V15 we have wired to the stepper motor control signal 
